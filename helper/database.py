...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Want_To_Know_Mee" -metadata author="@Want_To_Know_Mee" -metadata:s:s title="Subtitled By :- @Want_To_Know_Mee" -metadata:s:a title="By :- @Want_To_Know_Mee" -metadata:s:v title="By:- @Want_To_Know_Mee" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
